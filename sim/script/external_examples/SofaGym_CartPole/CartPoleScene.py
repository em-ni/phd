"""
The next step is to modify the scene to include the components we defined in the toolbox in the previous step. 
We need to modify the CartPoleScene file.
In this step, we simply add objects of the three classes we defined to the root node of the scene with the required parameters: 
ApplyAction, RewardShaper, and GoalSetter.
...
It is also important to make sure that the scene includes the component that will be modified by the Gym action. 
In this case, the constantForceField component on the cart.
