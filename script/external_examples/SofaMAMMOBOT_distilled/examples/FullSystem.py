...
from source.sceneGenerate import MainHeader, addController
from source.nodes.catheter import CatheterNode
from source.nodes.sheath import SheathNode
from source.controllers.full_controller import SheathCatheterController
...
def createScene(parent):
    ...
    #Sheath controller
    addController(parent, SheathCatheterController)
