...
def SheathNode(parent, name = "Sheath", gridSize: list = [1, 1, 25], collgridSize: list =[1, 1, 62], scale: list = [1, 1, 1],
    ...
    sheath.addObject('SparseGridTopology', name='sp_topology', n=gridSize,
                     fileTopology='MAMMOBOT_meshes/Sheath/sheath_v5_3.obj')
    ...
    visual.addObject('MeshObjLoader', name='meshLoader_0', filename='MAMMOBOT_meshes/Sheath/sheath_v5_3.obj', handleSeams=1)
    ...
    sheath_coll.addObject('SparseGridTopology', name='sheath_loader', n=collgridSize, fileTopology='MAMMOBOT_meshes/Sheath/sheath_v5_3.obj')
