% This script finds the optimal parameters for the concentric ellipses
...
plot(x_hollow_ext, y_hollow_ext, 'k'); % Plot hollow channel
plot(x_hollow_int, y_hollow_int, 'k'); % Plot hollow channel
plot(x_coil_ext, y_coil_ext, 'k'); % Plot external coil
plot(x_coil_int, y_coil_int, 'k'); % Plot internal coil
