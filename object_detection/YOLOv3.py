...
The configuration is stored in a list called architecture. Each item in the list represents a layer in the network, and is either a tuple or a string. 
...
if __name__ == "__main__":
    ...
    # So the total number of predictions is 3 * 13 * 13 + 3 * 26 * 26 + 3 * 52 * 52 = 10647 per image, because each grid cell predicts 3 bounding boxes called anchors. 
    ...
    # The first dimension of the output is the batch size
    assert len(out) == 3
